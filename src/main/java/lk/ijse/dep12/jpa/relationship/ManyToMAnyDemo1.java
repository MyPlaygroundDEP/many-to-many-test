...
public class ManyToMAnyDemo1 {
    ...
    public static void main(String[] args) {
        try (EntityManagerFactory emf = JpaUtil.getEntityManagerFactory();
            ...
            try {
                tx.begin();
                Student st1 = new Student("S001", "kasun", "sampath", "galle", "011-2346542", Date.valueOf("2000-01-23"));
                Student st2 = new Student("S002", "nimal", "kumara", "badulla", "067-2346542", Date.valueOf("1980-01-01"));

                Course cs1 = new Course("C001", "DEP", "6 months");
